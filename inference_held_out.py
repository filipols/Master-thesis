...
def inference(cfg):
    ...
    if cfg.task_type == "event_label":
        ...
        print('METRICS:')
        print('-------------------------------------------------------------------')
        print(f'Mean F1 evaluated on HELD OUT set: {f1}')
        print(f'Mean RECALL evaluated on HELD OUT set: {recall}')
        print(f'Mean PRECISION evaluated on HELD OUT set: {precision}')
        ...
        print('METRICS:')
        print('-------------------------------------------------------------------')
        print(f'Mean Accuracy evaluated on HELD OUT set: {np.mean(accuracy):.4f}')
        print(f'Mean F1 evaluated on HELD OUT set: {f1:.4f}')
        print(f'Mean RECALL evaluated on HELD OUT set: {recall:.4f}')
        print(f'Mean AP evaluated on HELD OUT set: {ap:.4f}')
        print(f'Mean PRECISION evaluated on HELD OUT set: {precision:.4f}')
        print('-------------------------------------------------------------------')
        print(f'{precision:.4f}')
        print(f'{recall:.4f}')
